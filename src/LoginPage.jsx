...
const LoginPage = () => {
    ...
    return (
        <div className={`min-h-screen flex flex-col md:flex-row ${darkMode ? "bg-gray-900 text-white" : "bg-gray-50"}`}>
            {/* Left Section */}
            <div className="md:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-blue-600 to-blue-800">
                <div className="max-w-md text-center">
                    ...
                    />
                    <h1 className="text-4xl font-bold text-white mb-4">HR KPI Analytics Platform</h1>
